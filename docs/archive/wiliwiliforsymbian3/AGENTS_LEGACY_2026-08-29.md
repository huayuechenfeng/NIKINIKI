...
- current factual status: `docs/archive/wiliwiliforsymbian3/DEVELOPMENT_STAGE_REPORT_2026-08-25_ZH.md`;
- immediate work order: `docs/archive/plans/NEXT_WORK_PLAN_2026-08-29_ZH.md`;
- resolved repeat-entry evidence: `docs/research/player/PLAYER_0.7_SECOND_ENTRY_CRASH_ANALYSIS_ZH.md`;
- current media-compatibility evidence: `docs/research/player/PLAYER_0.7_CODEC_COMPATIBILITY_ZH.md`;
- 1.0 decoding policy and retained fallback order: `docs/archive/plans/PLAYER_1.0_DECODING_POLICY_ZH.md`;
- active software-decoder execution plan: `docs/research/player/PLAYER_1.0_SOFTWARE_DECODER_PLAN_ZH.md`;
- deferred BCM2763/“BCM2727” firmware research: `docs/research/player/post-1.0/POST_1.0_BCM2763_HWDEVICE_RESEARCH_ZH.md`;
- device verification history: `docs/reference/DEVICE_TEST_MATRIX.md`;
- release artifact details: `docs/releases/RELEASE_1.0.0_ZH.md` (0.9 and 0.7 remain historical).
