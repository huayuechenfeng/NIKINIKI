...
# 0.9 mainline always ships the ffmpegsoft2 software fallback.  Keep the
...
Write-Host 'Staged 0.9 mainline PPSSPP-FFmpeg archives in the Symbian SDK armv5 library directories.'
